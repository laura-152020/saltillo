...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var button = document.querySelector(".arrow3-button");
...
const plus = document.querySelector(".plus3"),
minus = document.querySelector(".minus3"),
num = document.querySelector(".num3");
